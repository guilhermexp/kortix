...
var persistViewMode = function (value) {
...
var readStoredViewMode = function () {
    if (typeof window === "undefined")
        return null;
    try {
...
function ViewModeProvider(_a) {
    ...
    var _b = (0, react_1.useState)("graph"), viewMode = _b[0], setViewModeState = _b[1];
    ...
    var handleSetViewMode = function (mode) {

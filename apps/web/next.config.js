...
var nextConfig = {
    ...
    rewrites: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                backendUrl = process.env.API_INTERNAL_URL || "http://localhost:4000";
                return [2 /*return*/, [
                        {
                            source: "/api/:path*",
                            destination: "".concat(backendUrl, "/api/:path*")
                        },
                        {
                            source: "/chat/:path*",
                            destination: "".concat(backendUrl, "/chat/:path*")
                        },
                    ]];
            });
        });
    ...
    webpack: function (config, _a) {
        ...
        if (!isServer) {
            ...
            config.ignoreWarnings = __spreadArray(__spreadArray([], (config.ignoreWarnings || []), true), [
                {

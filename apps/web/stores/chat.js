...
exports.usePersistentChatStore = (0, zustand_1.create)()(
		...
		(set, _get) => ({
			...
			setCurrentChatId: (projectId, chatId) => {
				set((state) => {
					...
					var _b
					var project =
						(_b = state.byProject[projectId]) !== null && _b !== void 0
							? _b
							: {
									currentChatId: null,
									conversations: {},
					...
					return {
						byProject: __assign(
							__assign({}, state.byProject),
							((_a = {}),
							(_a[projectId] = __assign(__assign({}, project), {
					...
					var record = {
						...
						lastUpdated: shouldTouchLastUpdated
							...
							: (_d =
										existing === null || existing === void 0
											? void 0
											: existing.lastUpdated) !== null && _d !== void 0
								? _d
								: now,
					}
					return {
						byProject: __assign(
							...
							(_a[projectId] = {
								...
								conversations: __assign(
									__assign({}, project.conversations),
									((_b = {}), (_b[chatId] = record), _b),
								),
							}),
							_a),
						),
						...
						byProject: __assign(
							...
							(_a[projectId] = {
								...
								conversations: __assign(
									__assign({}, project.conversations),
									((_b = {}),
									(_b[chatId] = __assign(__assign({}, existing), {
										title: title,
										lastUpdated: now,
									})),
									_b),
...
function usePersistentChat() {
	...
	var projectState = (0, exports.usePersistentChatStore)(
		(s) => s.byProject[projectId],
	)
	var setCurrentChatIdRaw = (0, exports.usePersistentChatStore)(
		(s) => s.setCurrentChatId,
	)
	var setConversationRaw = (0, exports.usePersistentChatStore)(
		(s) => s.setConversation,
	)
	var deleteConversationRaw = (0, exports.usePersistentChatStore)(
		(s) => s.deleteConversation,
	)
	var setConversationTitleRaw = (0, exports.usePersistentChatStore)(
		...
		var convs =
			(_a =
				projectState === null || projectState === void 0
					? void 0
					: projectState.conversations) !== null && _a !== void 0
				? _a
				: {}
	...
	var currentChatId =
		(_a =
			projectState === null || projectState === void 0
				? void 0
				: projectState.currentChatId) !== null && _a !== void 0
			? _a
			: null

...
export function ProjectSelector({ className }: ProjectSelectorProps = {}) {
	...
	return (
		<div className={cn("relative", className)}>
			<motion.button
				className="flex items-center gap-2 px-3 py-2 rounded-md border border-border bg-background text-foreground/80 hover:text-foreground hover:bg-muted/50 transition-colors"
					...
					<>
						...
						>
							<div className="p-1.5 max-h-64 overflow-y-auto">
								...
								<motion.div
									animate={{ opacity: 1 }}
									className="flex items-center gap-2 p-2 rounded-md hover:bg-muted/50 transition-colors cursor-pointer border-t border-border mt-1"
									initial={{ opacity: 0 }}
			...
			<AnimatePresence>
				{renameDialog.open && (
					...
					>
						<DialogContent className="sm:max-w-md bg-popover backdrop-blur-xl border-border text-foreground">
							<motion.div
			...
			<AnimatePresence>
				{deleteDialog.open && deleteDialog.project && (
					...
					>
						<DialogContent className="sm:max-w-2xl bg-popover backdrop-blur-xl border-border text-foreground">
							<motion.div
								animate={{ opacity: 1, scale: 1 }}
								exit={{ opacity: 0, scale: 0.95 }}
								initial={{ opacity: 0, scale: 0.95 }}

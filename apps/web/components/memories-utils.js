...
exports.getPastelBackgroundColor =
	exports.getSourceUrl =
	exports.formatDate =
		void 0
/**
...
var formatDate = (date) => {
	...
	var getOrdinalSuffix = (n) => {
		...
		var suffix =
			(_b =
				(_a = suffixes[(v - 20) % 10]) !== null && _a !== void 0
					? _a
					: suffixes[v]) !== null && _b !== void 0
				? _b
				: suffixes[0]
 ...
 */
var getPastelBackgroundColor = (seed) => {

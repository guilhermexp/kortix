...
function setupDragAutoScroll(containerRef, config) {
    ...
    var autoScroll = function () {
        ...
        var scrollZone = finalConfig.scrollZone, scrollSpeed = finalConfig.scrollSpeed, enableVertical = finalConfig.enableVertical, enableHorizontal = finalConfig.enableHorizontal;
        var scrollX = 0;
        var scrollY = 0;
    ...
    var findScrollableParent = function (element) {
        ...
        while (parent) {
            ...
            var isScrollable = (style.overflowY === "auto" ||

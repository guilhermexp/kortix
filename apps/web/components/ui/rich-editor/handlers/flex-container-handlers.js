...
exports.createHandleFlexContainerDrop = exports.createHandleFlexContainerDragLeave = exports.createHandleFlexContainerDragOver = void 0;
...
function createHandleFlexContainerDragOver(params) {
    return function (e, flexContainerId, position) {
        var container = params.container, draggingNodeId = params.draggingNodeId, setDragOverFlexId = params.setDragOverFlexId, setFlexDropPosition = params.setFlexDropPosition;
        e.preventDefault();
        e.stopPropagation();
 ...
 */
function createHandleFlexContainerDragLeave(setDragOverFlexId, setFlexDropPosition) {
    return function (e) {
        e.preventDefault();
        e.stopPropagation();
        setDragOverFlexId(null);
...
function createHandleFlexContainerDrop(params) {
    return function (e, flexContainerId, position) {
        var container = params.container, dispatch = params.dispatch, toast = params.toast, draggingNodeId = params.draggingNodeId, setDragOverFlexId = params.setDragOverFlexId, setFlexDropPosition = params.setFlexDropPosition;
        e.preventDefault();
        e.stopPropagation();
        ...
        var draggingResult = (0, editor_helpers_1.findNodeAnywhere)(draggingNodeId, container);
        var flexResult = (0, editor_helpers_1.findNodeAnywhere)(flexContainerId, container);
        ...
        if (isInSameContainer) {
            ...
            var currentIndex = flexContainer.children.findIndex(function (c) { return c.id === draggingNodeId; });
            ...
            dispatch(actions_1.EditorActions.updateNode(flexContainerId, {

...
exports.createHandleExtractFromFlex = exports.createHandleReverseImagesInFlex = exports.checkImagesInSameFlex = exports.createHandleClearImageSelection = exports.createHandleToggleImageSelection = exports.createHandleGroupSelectedImages = void 0;
 ...
 */
function createHandleGroupSelectedImages(params, selectedImageIds, clearSelection) {
    return function () {
        ...
        var imageNodes = [];
        var imageResults = [];
        for (var _i = 0, selectedImageIds_1 = selectedImageIds; _i < selectedImageIds_1.length; _i++) {
        ...
        var parentIds = new Set(imageResults.map(function (r) { return r.parentId; }).filter(Boolean));
        var hasFlexParent = imageResults.some(function (r) { var _a; return r.parent && ((_a = r.parent.attributes) === null || _a === void 0 ? void 0 : _a.layoutType) === "flex"; });
        ...
        for (var _a = 0, _b = container.children; _a < _b.length; _a++) {
            ...
            if (selectedImageIds.has(child.id)) {
                ...
                if (index > 0) {
                    ...
                    var nextNonSelected = container.children.find(function (c) { return !selectedImageIds.has(c.id); });
                    if (nextNonSelected) {
        ...
        for (var _c = 0, selectedImageIds_2 = selectedImageIds; _c < selectedImageIds_2.length; _c++) {
        ...
        toast({
            ...
            description: "".concat(imageNodes.length, " images placed in a flex layout")
        });
        clearSelection();
    };
}
 ...
 */
function createHandleToggleImageSelection(selectedImageIds, setSelectedImageIds) {
...
function checkImagesInSameFlex(params, selectedImageIds) {
    ...
    var imageResults = [];
    for (var _i = 0, selectedImageIds_3 = selectedImageIds; _i < selectedImageIds_3.length; _i++) {
    ...
    var firstParentId = (_a = imageResults[0]) === null || _a === void 0 ? void 0 : _a.parentId;
    var firstParent = (_b = imageResults[0]) === null || _b === void 0 ? void 0 : _b.parent;
    if (!firstParentId ||
        !firstParent ||
        ((_c = firstParent.attributes) === null || _c === void 0 ? void 0 : _c.layoutType) !== "flex") {
        return { inSameFlex: false, flexParentId: null };
    }
    // Check all images have the same flex parent
    var allSameParent = imageResults.every(function (r) {
        var _a, _b;
        return r.parentId === firstParentId &&
            ((_b = (_a = r.parent) === null || _a === void 0 ? void 0 : _a.attributes) === null || _b === void 0 ? void 0 : _b.layoutType) === "flex";
    });
    return {
 ...
 */
function createHandleReverseImagesInFlex(params, selectedImageIds, flexParentId) {
    return function () {
        var container = params.container, dispatch = params.dispatch, toast = params.toast;
        // Find the flex container
        var flexResult = (0, editor_helpers_1.findNodeAnywhere)(flexParentId, container);
        ...
        selectedIndices.forEach(function (originalIndex, i) {
        ...
        dispatch(actions_1.EditorActions.updateNode(flexParentId, {
            children: children
        }));
        toast({
            title: "Images reversed!",
            description: "Order of ".concat(selectedImageIds.size, " images reversed")
        });
    };
}
 ...
 */
function createHandleExtractFromFlex(params, selectedImageIds, flexParentId, clearSelection) {
    return function () {
        var _a, _b;
        var container = params.container, dispatch = params.dispatch, toast = params.toast;
        // Find the flex container
        ...
        var flexContainer = flexResult.node;
        var imagesToExtract = [];
        var remainingChildren = flexContainer.children.filter(function (child) {
            if (selectedImageIds.has(child.id)) {
        ...
        if (remainingChildren.length <= 1) {
            ...
            var flexIndex = container.children.findIndex(function (c) { return c.id === flexParentId; });
            if (flexIndex > 0) {
                ...
                var lastNodeId = remainingChildren.length === 1 && firstRemaining
                    ? firstRemaining.id
                    : prevNode === null || prevNode === void 0 ? void 0 : prevNode.id;
                if (!lastNodeId)
                    return;
                var currentNodeId_1 = lastNodeId;
                imagesToExtract.forEach(function (image) {
                    actions.push(actions_1.EditorActions.insertNode(image, currentNodeId_1, "after"));
                ...
                if (remainingChildren.length === 1) {
                    ...
                    if (child) {
                        actions.push(actions_1.EditorActions.insertNode(child, ((_a = container.children[1]) === null || _a === void 0 ? void 0 : _a.id) || container.id, ((_b = container.children[1]) === null || _b === void 0 ? void 0 : _b.id) ? "before" : "append"));
                    }
                }
                imagesToExtract.forEach(function (image) {
                    var _a, _b;
                    actions.push(actions_1.EditorActions.insertNode(image, ((_a = container.children[1]) === null || _a === void 0 ? void 0 : _a.id) || container.id, ((_b = container.children[1]) === null || _b === void 0 ? void 0 : _b.id) ? "before" : "append"));
                });
            }
        }
        else {
            // Update flex container with remaining children
            actions.push(actions_1.EditorActions.updateNode(flexParentId, {
                children: remainingChildren
            }));
            // Insert extracted images after the flex container
            var lastNodeId_1 = flexParentId;
            imagesToExtract.forEach(function (image) {
                actions.push(actions_1.EditorActions.insertNode(image, lastNodeId_1, "after"));
        ...
        toast({
            ...
            description: "".concat(imagesToExtract.length, " images removed from flex container")
        });
        clearSelection();
    };
}

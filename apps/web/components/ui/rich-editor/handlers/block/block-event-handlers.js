...
exports.createHandleBackgroundColorChange = exports.createHandleCommandSelect = exports.createHandleClick = exports.createHandleKeyDown = exports.createHandleInput = exports.createHandleCompositionEnd = exports.createHandleCompositionStart = void 0;
var tree_operations_1 = require("../../utils/tree-operations");
/**
 * Create handle composition start
 */
function createHandleCompositionStart() {
    return function (isComposingRef) {
        return function () {
...
function createHandleInput(params) {
    return function (e) {
        var textNode = params.textNode, readOnly = params.readOnly, onInput = params.onInput, onChangeBlockType = params.onChangeBlockType, showCommandMenu = params.showCommandMenu, setShowCommandMenu = params.setShowCommandMenu, setCommandMenuAnchor = params.setCommandMenuAnchor, shouldPreserveSelectionRef = params.shouldPreserveSelectionRef;
...
function createHandleKeyDown(params) {
    return function (e) {
        var textNode = params.textNode, onKeyDown = params.onKeyDown, onCreateNested = params.onCreateNested, showCommandMenu = params.showCommandMenu, setShowCommandMenu = params.setShowCommandMenu, setCommandMenuAnchor = params.setCommandMenuAnchor, currentContainer = params.currentContainer, dispatch = params.dispatch;
        ...
        var isListItem = textNode.type === "ul" ||
            textNode.type === "ol" ||
            textNode.type === "li";
        ...
        if (e.key === "Enter" && !e.shiftKey && isListItem) {
            ...
            var parent_1 = (0, tree_operations_1.findParentById)(currentContainer, textNode.id);
            if (parent_1) {
                ...
                setTimeout(function () {
                    var newElement = document.querySelector("[data-node-id=\"".concat(newListItem_1.id, "\"]"));
                    if (newElement) {
                        newElement.focus();
                    }
                }, 0);
...
function createHandleClick(params) {
    return function (e) {
        var readOnly = params.readOnly, onClick = params.onClick;
...
function createHandleCommandSelect(params) {
    return function (commandValue) {
        var textNode = params.textNode, onChangeBlockType = params.onChangeBlockType, onInsertImage = params.onInsertImage, onCreateList = params.onCreateList, localRef = params.localRef, setShowCommandMenu = params.setShowCommandMenu, setCommandMenuAnchor = params.setCommandMenuAnchor;
        if (!localRef.current)
            return;
        // Clear the "/" character

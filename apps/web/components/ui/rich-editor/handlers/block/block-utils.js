...
exports.restoreSelection = exports.saveSelection = exports.buildHTML = exports.getTypeClassName = exports.escapeHTML = void 0;
/**
...
function buildHTML(textNode, readOnly) {
    ...
    var hasChildren = Array.isArray(textNode.children) && textNode.children.length > 0;
        ...
        return textNode
            ...
            if (line.children && line.children.length > 0) {
                lineContent = line.children
                    ...
                    var isHexColor = child.className && child.className.startsWith("#");
                    ...
                    if (child.href) {
                        ...
                        var combinedClasses = [linkClasses, italicSpacing]
                            .filter(Boolean)
                            .join(" ");
                        return "<a href=\"".concat(child.href, "\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"").concat(combinedClasses, "\"").concat(styleAttr, ">").concat(childContent, "</a>");
                    }
                    if (child.elementType) {
                        ...
                        var combinedClasses = [elementClasses, classes, italicSpacing]
                            .filter(Boolean)
                            .join(" ");
                        return "<span class=\"".concat(combinedClasses, "\"").concat(styleAttr, ">").concat(childContent, "</span>");
                    }
                    if (classes || colorStyle) {
                        ...
                        var classAttr = combinedClasses
                            ...
                            : "";
                        return "<span".concat(classAttr).concat(styleAttr, ">").concat(childContent, "</span>");
                    }
                    return childContent;
                })
                    .join("");
...
function restoreSelection(localRef, savedSelection) {
    ...
    try {
        ...
        if (startNode && endNode) {
            var start = startNode;
            var end = endNode;
            range.setStart(start, Math.min(startOffset, ((_a = start.textContent) === null || _a === void 0 ? void 0 : _a.length) || 0));
            if (savedSelection.collapsed) {
                range.collapse(true);
            }
            else {
                range.setEnd(end, Math.min(endOffset, ((_b = end.textContent) === null || _b === void 0 ? void 0 : _b.length) || 0));
            }

...
exports.createHandleKeyDown = exports.createHandleClickWithModifier = exports.createHandleContentChange = void 0;
...
function createHandleContentChange(params, contentUpdateTimers) {
    return function (nodeId, element) {
        ...
        if (newContent !== currentContent) {
            ...
            var timer = setTimeout(function () {
                ...
                if (orderedListMatch && node.type === "p") {
                    ...
                    var _ = orderedListMatch[0], number = orderedListMatch[1], content = orderedListMatch[2];
                    dispatch(actions_1.EditorActions.updateNode(node.id, {
                        type: "li",
                        content: content
                    }));
                }
                    ...
                    if (textLines.length > 1) {
                        ...
                        var updatedLines = textLines.map(function (lineText) {
                    ...
                    var parseDOMToInlineChildren = require("../utils/editor-helpers").parseDOMToInlineChildren;
...
function createHandleClickWithModifier(params) {
    return function (e, nodeId) {
        var container = params.container, onToggleImageSelection = params.onToggleImageSelection;
...
function createHandleKeyDown(params) {
    return function (e, nodeId) {
        var container = params.container, dispatch = params.dispatch, nodeRefs = params.nodeRefs, lastEnterTime = params.lastEnterTime;
        ...
        if (e.key === "Enter") {
            ...
            if (e.shiftKey) {
                ...
                if (node_1.type === "ul" || node_1.type === "ol" || node_1.type === "li") {
                    ...
                    if (selection_1 && selection_1.rangeCount > 0) {
                        ...
                        if (element_1) {
                            var createHandleContentChange_1 = require("./keyboard-handlers").createHandleContentChange;
            ...
            if (node_1.type === "ul" || node_1.type === "ol" || node_1.type === "li") {
                ...
                if (!beforeCursor.trim() && !afterCursor.trim()) {
                    ...
                    dispatch(actions_1.EditorActions.insertNode(newNode_1, actualNodeId, "after"));
                ...
                dispatch(actions_1.EditorActions.updateNode(actualNodeId, {
                ...
                dispatch(actions_1.EditorActions.insertNode(newNode_2, actualNodeId, "after"));
            ...
            // Regular paragraph/heading - create normal block
            {
                ...
                if (nodeHasInlineChildren && node_1.children) {
                    ...
                    for (var _i = 0, _a = node_1.children; _i < _a.length; _i++) {
                        ...
                        if (splitDone) {
                            ...
                            if (offsetInChild > 0) {
                                beforeChildren.push(__assign(__assign({}, child), { content: child.content.substring(0, offsetInChild) }));
                            }
                            // Part after cursor goes to new node
                            if (offsetInChild < childLength) {
                                afterChildren.push(__assign(__assign({}, child), { content: child.content.substring(offsetInChild) }));
                            }
                            splitDone = true;
                        }
                        currentPos = childEnd;
                    ...
                    dispatch(actions_1.EditorActions.updateNode(actualNodeId, {
                        ...
                        content: beforeChildren.length === 0 ? beforeCursor : node_1.content
                    }));
                    ...
                    dispatch(actions_1.EditorActions.insertNode(newNode, actualNodeId, "after"));
                ...
                setTimeout(function () {
                    var newElement = nodeRefs.current.get("".concat(node_1.type, "-") + currentTime_1);
                    if (newElement) {
                        newElement.focus();
            ...
            var selection = window.getSelection();
            var cursorAtStart = selection && selection.anchorOffset === 0 && selection.isCollapsed;
            ...
            if ((cursorAtStart && isNodeEmpty) || node.type === "br") {
                e.preventDefault();
                var currentIndex = siblings.findIndex(function (n) { return n.id === nodeId; });
                // Don't delete if it's the only node in the container
                if (siblings.length === 1) {
                    // Just clear the content instead
                    if ((0, types_1.hasInlineChildren)(node)) {
                        dispatch(actions_1.EditorActions.updateNode(node.id, { children: [] }));
                    }
                ...
                var nonImageBlocks = siblings.filter(function (n) {
                    if (!(0, types_1.isTextNode)(n))

...
exports.createHandleTypeChange = exports.createHandleApplyFontSize = exports.createHandleApplyColor = exports.createHandleFormat = exports.createHandleSelectionChange = void 0;
...
function createHandleSelectionChange(params, selectionDispatchTimerRef) {
    return function () {
        var container = params.container, state = params.state, dispatch = params.dispatch, selectionManager = params.selectionManager, nodeRefs = params.nodeRefs;
        var selection = window.getSelection();
        var hasText = selection !== null &&
        ...
        if (hasText && selection) {
            ...
            if (currentElement) {
                ...
                if (actualNodeId) {
                    ...
                    var actualNode = (0, tree_operations_1.findNodeById)(container, actualNodeId);
                    if (actualNode && (0, types_1.isTextNode)(actualNode)) {
                        ...
                        var detected = (0, editor_helpers_1.detectFormatsInRange)(actualNode, start, end);
                        var selectionInfo_1 = {
                        ...
                        if (changed) {
                            ...
                            selectionDispatchTimerRef.current = setTimeout(function () {
                                dispatch(actions_1.EditorActions.setCurrentSelection(selectionInfo_1));
...
function createHandleFormat(params) {
    return function (format) {
        var container = params.container, dispatch = params.dispatch, selectionManager = params.selectionManager, nodeRefs = params.nodeRefs;
        ...
        var start = refSelection.start, end = refSelection.end, nodeId = refSelection.nodeId, formats = refSelection.formats;
        ...
        setTimeout(function () {
            var updatedNode = container.children.find(function (n) { return n.id === nodeId; });
        }, 100);
...
function createHandleApplyColor(params, toast, setSelectedColor) {
    return function (color) {
        var dispatch = params.dispatch, selectionManager = params.selectionManager, nodeRefs = params.nodeRefs;
        // Get fresh selection from ref
        var refSelection = selectionManager.getSelection();
        if (!refSelection)
            return;
        var nodeId = refSelection.nodeId, start = refSelection.start, end = refSelection.end;
...
function createHandleTypeChange(params, currentNode, handleSelectionChange) {
    return function (type) {
        ...
        if (refSelection) {
            ...
            var start_1 = refSelection.start, end_1 = refSelection.end, nodeId_1 = refSelection.nodeId;
            ...
            dispatch(actions_1.EditorActions.updateNode(currentNode.id, {
                type: type
            }));
        }
    };

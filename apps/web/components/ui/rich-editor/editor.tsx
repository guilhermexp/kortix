	...
	return (
		<div className="bg-transparent flex flex-1 flex-col transition-colors duration-300">
			...
			<div className="mx-auto flex w-full flex-1 flex-col">
				<Card
					className="flex flex-1 flex-col gap-3 rounded-none border-2 pt-0 shadow-2xl transition-all duration-300"
					style={{ backgroundColor: "#0f1419", backdropFilter: "blur(12px)" }}
				>

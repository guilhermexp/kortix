...
exports.searchUserFriendlyClasses = exports.getUserFriendlyClasses = exports.classMappings = void 0;
...
function getUserFriendlyClasses() {
    var grouped = new Map();
    exports.classMappings.forEach(function (_a) {
        var category = _a.category, userFriendly = _a.userFriendly, tailwindClass = _a.tailwindClass;
...
exports.getUserFriendlyClasses = getUserFriendlyClasses;
/**
 * Search user-friendly classes
 */
function searchUserFriendlyClasses(query) {
    var lowerQuery = query.toLowerCase();
    var grouped = new Map();
    exports.classMappings
        .filter(function (_a) {
        var userFriendly = _a.userFriendly, tailwindClass = _a.tailwindClass;
        return userFriendly.toLowerCase().includes(lowerQuery) ||
...
exports.searchUserFriendlyClasses = searchUserFriendlyClasses;

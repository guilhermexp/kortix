...
export async function getSettings(client: SupabaseClient, organizationId: string) {
...
export async function updateSettings(client: SupabaseClient, organizationId: string, body: unknown) {
  ...
  const updatePayload = {
    ...
    google_drive_custom_key_enabled: payload.googleDriveCustomKeyEnabled ?? false,

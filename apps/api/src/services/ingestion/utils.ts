...
export function mergeRecords(...records: Array<JsonRecord | null | undefined>): JsonRecord {
...
export function sanitizeProcessingMetadata(metadata?: Record<string, unknown> | null): Record<string, unknown> | null {

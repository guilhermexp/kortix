			...
			const mimeTypeInputs = [
				{
					type: "file",
					content: "pdf content",
					options: { filename: "doc.pdf", mimeType: "application/pdf" },
				},
				{
					type: "file",
					content: "pdf content",
	...
	describe("Performance Optimization", () => {
		...
		it("should handle concurrent PDF processing", async () => {
			const pdfInputs = [
				{
					type: "file",
					content: "data:application/pdf;base64,JVBERi0xLjQK1",
					options: { filename: "pdf1.pdf" },
				},
				{
					type: "file",
					content: "data:application/pdf;base64,JVBERi0xLjQK2",
					options: { filename: "pdf2.pdf" },
				},
				{
					type: "file",
					content: "data:application/pdf;base64,JVBERi0xLjQK3",
					options: { filename: "pdf3.pdf" },
				},
			]

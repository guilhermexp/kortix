...
```bash OpenAI
http://localhost:4000/v3/https://api.openai.com/v1/chat/completions
```
...
```bash Other provider
http://localhost:4000/v3/<your-provider's-openai-endpoint>
```
...
```bash cURL
curl http://localhost:4000/v3/https://api.openai.com/v1/chat/completions \

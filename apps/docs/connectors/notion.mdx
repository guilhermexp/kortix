...
<Tabs>
  ...
  <Tab title="cURL">
    ```bash
    curl -X POST "http://localhost:4000/v3/connections/notion" \
...
<Tabs>
  ...
  <Tab title="cURL">
    ...
    curl -X POST "http://localhost:4000/v3/connections/notion/connection" \
      -H "Authorization: Bearer $SUPERMEMORY_API_KEY" \
      -H "Content-Type: application/json" \
    ...
    curl -X POST "http://localhost:4000/v3/connections/notion/documents" \
      -H "Authorization: Bearer $SUPERMEMORY_API_KEY" \
      -H "Content-Type: application/json" \
      -d '{"containerTags": ["user-123", "notion-workspace"]}'
...
<Tabs>
  ...
  <Tab title="cURL">
    ...
    # Delete by provider and container tags
    curl -X DELETE "http://localhost:4000/v3/connections/notion" \
      -H "Authorization: Bearer $SUPERMEMORY_API_KEY" \
      -H "Content-Type: application/json" \

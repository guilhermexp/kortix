...
- **Forgotten Memories Search (Planned):** `include.forgottenMemories` is part of the future `/v4/search` design. Not available in v1.2.
...
- **Memory Search Endpoint (Planned):** `/v4/search` will be optimized for conversational AI and memory retrieval. Not available in v1.2.

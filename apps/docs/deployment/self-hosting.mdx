...
- **Autenticação**: Custom session-based auth com envio de e-mails via Resend
...
Crie sua conta pelo frontend (usa autenticação customizada) e confirme o fluxo completo: login, criação de documentos, busca e chat.

...
export type ConnectionProvider =
	(typeof ConnectionProvider)[keyof typeof ConnectionProvider]
...
export type CreateMemoryRelationship = z.infer<
	typeof CreateMemoryRelationshipSchema
>
...
export function validateData<T>(schema: z.ZodSchema, data: unknown): T {
	...
	if (!result.success) {
		...
		throw new Error(`Validation error: ${JSON.stringify(errors.fieldErrors)}`)
	}

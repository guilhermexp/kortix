...
export interface PreviewService {
  generate(url: string, options?: PreviewGenerationOptions): Promise<PreviewData>
  generateBatch(urls: string[], options?: PreviewGenerationOptions): Promise<PreviewData[]>
  clearCache?(): void

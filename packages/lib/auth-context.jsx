...
function AuthProvider(_a) {
    ...
    var user = (data === null || data === void 0 ? void 0 : data.user)
        ? __assign(__assign({}, data.user), { isAnonymous: false }) : null;
    return (<AuthContext.Provider value={{
            session: (_b = data === null || data === void 0 ? void 0 : data.session) !== null && _b !== void 0 ? _b : null,
            user: user,
            org: (_c = data === null || data === void 0 ? void 0 : data.organization) !== null && _c !== void 0 ? _c : null,

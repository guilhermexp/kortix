...
class Logger {
  ...
  logCache(operation: 'hit' | 'miss' | 'set' | 'clear', key: string, context?: Record<string, any>): void {
...
export const createLogger = (service: string, options?: Omit<LoggerOptions, 'service'>) => {

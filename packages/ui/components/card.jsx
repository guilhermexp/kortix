...
function Card(_a) {
    ...
    return (<div className={(0, utils_1.cn)("bg-card text-card-foreground flex flex-col gap-6 rounded-xl border py-6 shadow-sm", className)} data-slot="card" {...props}/>);
}
exports.Card = Card;
...
function CardTitle(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<div className={(0, utils_1.cn)("leading-none font-semibold", className)} data-slot="card-title" {...props}/>);
}

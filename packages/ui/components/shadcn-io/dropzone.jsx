...
var Dropzone = function (_a) {
    ...
    return (<DropzoneContext.Provider key={JSON.stringify(src)} value={{ src: src, accept: accept, maxSize: maxSize, minSize: minSize, maxFiles: maxFiles }}>
			<button_1.Button className={(0, utils_1.cn)("relative h-auto w-full flex-col overflow-hidden p-8", isDragActive && "outline-none ring-1 ring-ring", className)} disabled={disabled} type="button" variant="outline" {...getRootProps()}>
...
var useDropzoneContext = function () {
...
var DropzoneContent = function (_a) {
    ...
    return (<div className={(0, utils_1.cn)("flex flex-col items-center justify-center", className)}>
...
var DropzoneEmptyState = function (_a) {
    var children = _a.children, className = _a.className;
    var _b = useDropzoneContext(), src = _b.src, accept = _b.accept, maxSize = _b.maxSize, minSize = _b.minSize, maxFiles = _b.maxFiles;
    if (src) {
        return null;
    }
    if (children) {
